<aside class="relative w-[1500x] h-[75px] bg-red-600 shadow-xl mt-7">
    ...
    <div class="flex justify-center items-center">
        ...
        <div class="inline-flex justify-center items-center">
            <a href="/login">
                <p class="ml-10 mt-6 font-bold text-white hover:text-black">Login</p>
            </a>
            <p class="mt-6 font-bold text-white">|</p>
            <a href="/register">
                <p class="mt-6 font-bold text-white hover:text-black">Daftar</p>
            </a>
        </div>
    </div>
