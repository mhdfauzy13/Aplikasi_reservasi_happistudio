<body class="bg-gray-50 dark:bg-slate-900">
  ...
  <!-- Sidebar -->
  <div id="application-sidebar" class="hs-overlay hs-overlay-open:translate-x-0 -translate-x-full transition-all duration-300 transform hidden fixed top-0 left-0 bottom-0 z-[60] w-64 bg-red-500 bg-opacity-2 border-r border-gray-200 pt-7 pb-10 overflow-y-auto scrollbar-y lg:block lg:translate-x-0 lg:right-auto lg:bottom-0 dark:scrollbar-y dark:bg-gray-800 dark:border-gray-700">
    <div class="flex justify-between  items-center space-x-3">
        <img src="assets/image/logofix.png" width="50" height="50" viewBox="0 0 34 34">
        <p class="text-2xl leading-6 text-white text-bold">HAPPI STUDIO</p>
      </div>
    ...
    <nav class="hs-accordion-group p-6 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
      <ul class="space-y-1.5">
        ...
        <div>
          <a class="hs-accordion-toggle flex items-center gap-x-3.5 py-2 px-2.5 hs-accordion-active:text-black hs-accordion-active:hover:bg-transparent text-sm text-white rounded-md hover:bg-red-200 dark:bg-gray-800 dark:hover:bg-gray-900 dark:text-slate-400 dark:hover:text-slate-300 dark:hs-accordion-active:text-white" href={{ route('dashboard.index') }}>
        ...
        <div>
          <a class="hs-accordion-toggle flex items-center gap-x-3.5 py-2 px-2.5 hs-accordion-active:text-blue-600 hs-accordion-active:hover:bg-transparent text-sm text-white rounded-md hover:bg-red-200 dark:bg-gray-800 dark:hover:bg-gray-900 dark:text-slate-400 dark:hover:text-slate-300 dark:hs-accordion-active:text-white" href={{ route('pakets.index') }}>
            {{-- <svg class="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
              <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z"/>
              <path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8zm8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1z"/>
            </svg> --}}
            <img src="../assets/icon/gallery.png" alt="" class="filter invert">
            Data Pricelist
            <svg class="hs-accordion-active:block ml-auto hidden w-3 h-3 text-gray-600 group-hover:text-gray-500 dark:text-gray-400" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M2 11L8.16086 5.31305C8.35239 5.13625 8.64761 5.13625 8.83914 5.31305L15 11" stroke="currentColor" stroke-width="2" stroke-linecap="round"></path>
            </svg>
        ...
        <div>
          <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-white rounded-md hover:bg-red-200 dark:hover:bg-gray-900 dark:text-slate-400 dark:hover:text-slate-300" href="javascript:;">
            <img src="../assets/icon/wallet.png" alt="" class="filter invert">
            Rekap Pemasukan
          </a>
        </div>

      <div>
    <form class="flex items-center gap-x-3.5 py-2 px-2.5 mt-10 text-sm rounded-md transition duration-300 hover:bg-red-200 dark:hover:bg-gray-900" method="POST" action="{{ route('logout') }}">
        @csrf
        <div href="route('logout')" onclick="event.preventDefault(); this.closest('form').submit();" class="flex items-center">
