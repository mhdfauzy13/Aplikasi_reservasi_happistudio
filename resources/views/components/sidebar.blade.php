...
<div id="application-sidebar-brand"
    class="hs-overlay hs-overlay-open:translate-x-0 -translate-x-full transition-all duration-300 transform hidden fixed top-0 left-0 bottom-0 z-[60] w-64 bg-red-500 bg-opacity-25 p-4 pt-7 pb-10 overflow-y-auto scrollbar-y lg:block lg:translate-x-0 lg:right-auto lg:bottom-0">
    <div class="flex warp px-6">
        {{-- <img src="assets/image/logofix.png" alt=""> --}}
        <a class="flex-none text-xl font-semibold text-red-500" href="#" aria-label="Happistudio">Happistudio</a>
    </div>

    <nav class="hs-accordion-group p-6 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
        <ul class="space-y-1.5">
            <li>
                <a class="flex items-center gap-x-3 py-2 px-2.5 bg-red-300 text-sm text-black rounded-md"
                    href="javascript:;">
            ...
            <li class="hs-accordion" id="users-accordion">
                <a class="hs-accordion-toggle flex items-center gap-x-3.5 py-2 px-2.5 hs-accordion-active:text-white hs-accordion-active:hover:bg-transparent text-sm text-black hover:text-white rounded-md hover:bg-red-300"
                    href="javascript:;">
                    <svg class="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                        fill="currentColor" viewBox="0 0 16 16">
                        <path
                    ...
                    <svg class="hs-accordion-active:block ml-auto hidden w-3 h-3 text-white group-hover:text-white"
                    ...
                    <svg class="hs-accordion-active:hidden ml-auto block w-3 h-3 text-white group-hover:text-white"
                        width="16" height="16" viewBox="0 0 16 16" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
            ...
            <li><a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-white hover:text-black rounded-md hover:bg-red-300 "
                    href="javascript:;">
                    <svg class="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                        fill="currentColor" viewBox="0 0 16 16">
                        <path
